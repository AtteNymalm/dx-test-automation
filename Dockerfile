...
CMD ["sh", "-c", "/usr/bin/Xvfb :99 &  /usr/bin/x11vnc -bg ; sudo chmod -R 775 /usr/src/tests/ ; sudo robot -d /usr/src/tests/results /usr/src/tests/test-tutorial-starter.robot"]